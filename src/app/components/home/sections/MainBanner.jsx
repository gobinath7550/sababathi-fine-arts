            ...
            <div className="bg-black/70 py-14 sm:py-20 md:py-32 flex flex-col items-center justify-center gap-5 max-sm:gap-0">
                <div className="xl:max-w-[70rem] m-auto p-7">
                    <div className="flex flex-col items-center justify-center gap-6">
                        ...
                        <h2 className="font-extrabold text-xs sm:text-[0.975rem] text-center leading-5 text-white text-shadow tracking-widest px-8">
                            {
                        ...
                        <div className="text-white flex items-center justify-center gap-3 sm:pt-5">
                            <a
                                ...
                                className="text-sm tracking-widest font-extrabold max-sm:text-[9px] leading-none border-2 border-white rounded-full p-3 px-5 hover:text-[#fa0029] hover:border-[#fa0029] transition-all cursor-pointer"
                            >
                                Read More
                            </a>
                            <a
                                href="/products"
                                className="text-sm tracking-widest font-extrabold max-sm:text-[9px] leading-none border-2 border-white rounded-full p-3 px-5 bg-[#fa0029] cursor-pointer hover:bg-transparent transition-all"
                            >
                                View Products
                            </a>
                        </div>
